const Footer = ({ footerAPI }: any) => {
  ...
  return (
    <>
      <footer className="bg-gradient-to-b from-emerald-400 to-green-200  pb-7">
        ...
        <div className="w-7/12 lg:w-[95vw] m-auto ">
          ...
          <div className="flex items-center justify-between px-7 md:px-0 md:gap-5 md:flex-col-reverse">
            <p className="text-sm md:text-center">
              ...
              <span className="font-semibold">Agency Logo</span>
            </p>
